...
const FacultyDetails = () => {
    ...
    const { data: facultyData, isLoading } = useGetSingleFacultyByIdQuery({ faculty: facultyId as string });
    ...
    return (
        <Card title="Faculty Details" style={{ margin: "20px" }}>
            <img
            ...
            <Descriptions bordered column={1}>
                ...
                <Descriptions.Item label="Designation">{facultyData?.data?.designation}</Descriptions.Item>
                <Descriptions.Item label="Academic Department">{facultyData?.data?.academicDepartment?.name}</Descriptions.Item>
                <Descriptions.Item label="Academic Faculty">{facultyData?.data?.academicDepartment?.academicFaculty?.name}</Descriptions.Item>
            </Descriptions>
        </Card>
    );
};
